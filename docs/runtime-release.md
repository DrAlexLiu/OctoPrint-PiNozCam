...
```text
pinozcam-runtime @ https://github.com/DrAlexLiu/OctoPrint-PiNozCam/releases/download/1.1.0/pinozcam_runtime-1.1.0-py3-none-manylinux2014_aarch64.whl
pinozcam-runtime-gpu @ https://github.com/DrAlexLiu/OctoPrint-PiNozCam/releases/download/1.1.0/pinozcam_runtime_gpu-1.1.0-py3-none-manylinux_2_35_aarch64.whl
```

Hardware-specific targets use the same fixed-tag form:

```text
pinozcam-runtime-rknn3566 @ https://github.com/DrAlexLiu/OctoPrint-PiNozCam/releases/download/1.1.0/pinozcam_runtime_rknn3566-1.1.0-py3-none-linux_aarch64.whl
```
